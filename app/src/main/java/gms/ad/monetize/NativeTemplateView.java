...
public class NativeTemplateView extends FrameLayout {
    ...
    public NativeTemplateView(Context context, int Size) {
        super(context);
    ...
    public NativeTemplateView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public NativeTemplateView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public NativeTemplateView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.medium_nativeview) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.small_nativeview) {
            ...
            if (Native_Ad_Size == 2) {
                ...
                templateType =
                        attributes.getResourceId(
                                R.styleable.TemplateView_gnt_template_type, R.layout.medium_nativeview);
                ...
                templateType =
                        attributes.getResourceId(
                                R.styleable.TemplateView_gnt_template_type, R.layout.small_nativeview);
                ...
                templateType =
                        attributes.getResourceId(
                                R.styleable.TemplateView_gnt_template_type, R.layout.fc_nativeview);
