...
public class Gotas {
    ...
    public void Tappx_Reward(Activity mContext, String title, String description, int Popupmenu_Type, CustomDialogue progressDialog) {
    ...
    public void After_2_3(Context aContext) {
